...
def main(params):
    ...
    # Convert datetime columns type from object to datetime
    # These columns are named differently in Yellow and Green datasets
    if "tpep_pickup_datetime" in df.columns:  # Yellow Taxi
        df.tpep_pickup_datetime = pd.to_datetime(df.tpep_pickup_datetime)
        df.tpep_dropoff_datetime = pd.to_datetime(df.tpep_dropoff_datetime)
    elif "lpep_pickup_datetime" in df.columns:  # Green Taxi
